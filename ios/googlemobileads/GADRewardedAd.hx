...
extern class GADRewardedAd
//implements cpp.objc.Protocol<GADAdMetadataProvider>
//implements cpp.objc.Protocol<GADFullScreenPresentingAd>
{

	@:native("alloc")
	overload public static function alloc():GADRewardedAd;

	@:native("autorelease")
	overload public static function autorelease():GADRewardedAd;
	...
	overload public function presentFromRootViewControllerUserDidEarnRewardHandler(rootViewController:Dynamic, userDidEarnRewardHandler:Dynamic):Void;
